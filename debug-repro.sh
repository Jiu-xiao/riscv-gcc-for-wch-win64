...
set +e
riscv32-unknown-elf-gcc -v -c /tmp/conftest.c -o /tmp/conftest.o
rc=$?
echo "gcc_rc=$rc"
tmpw="$HOME/.wine/drive_c/users/root/Temp"
ls -la "$tmpw" | sed -n '1,120p' || true
ls -la /tmp/conftest.o || true
exit "$rc"
